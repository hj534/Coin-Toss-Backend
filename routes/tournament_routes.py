...
@router.get("/get_bimonthly_tournaments/", response_model=list[TournamentOut])
async def get_bimonthly_tournaments():
    return await service.get_bimonthly_tournaments()
